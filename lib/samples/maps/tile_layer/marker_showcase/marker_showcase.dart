...
class _DraggableMarkerState extends SampleViewState
  ...
  void initState() {
    ...
    _animationController = AnimationController(
        vsync: this, duration: const Duration(milliseconds: 400), value: 0.1);
  ...
  void _addMarker(Offset position) {
    ...
    // in that position.
    final MapLatLng markerPosition =
        _tileLayerController.pixelToLatLng(position);
