  ...
  void _loadTreeMapData() {
    if (model.locale == const Locale('en', 'US')) {
      _statesAreaData = <_State>[
        const _State(
            0.809, Color.fromRGBO(255, 215, 0, 1.0), 'New South Wales'),
        const _State(1.857, Color.fromRGBO(72, 209, 204, 1.0), 'Queensland'),
        const _State(
            1.419, Color.fromRGBO(255, 78, 66, 1.0), 'Northern Territory'),
        const _State(0.237, Color.fromRGBO(171, 56, 224, 0.75), 'Victoria'),
        const _State(
            1.044, Color.fromRGBO(126, 247, 74, 0.75), 'South Australia'),
        const _State(
            2.642, Color.fromRGBO(79, 60, 201, 0.7), 'Western Australia'),
    ...
    //Arabic.
      ...
      _statesAreaData = <_State>[
        ...
        const _State(
            1.419, Color.fromRGBO(255, 78, 66, 1.0), 'الإقليم الشمالي'),
        const _State(0.237, Color.fromRGBO(171, 56, 224, 0.75), 'فيكتوريا'),
        const _State(
            1.044, Color.fromRGBO(126, 247, 74, 0.75), 'جنوب استراليا'),
        const _State(2.642, Color.fromRGBO(79, 60, 201, 0.7),
    ...
    //French.
      ...
      _statesAreaData = <_State>[
        const _State(
            0.809, Color.fromRGBO(255, 215, 0, 1.0), 'Nouvelle Galles du Sud'),
        const _State(1.857, Color.fromRGBO(72, 209, 204, 1.0), 'Queensland'),
        const _State(
            1.419, Color.fromRGBO(255, 78, 66, 1.0), 'Territoire du Nord'),
        const _State(0.237, Color.fromRGBO(171, 56, 224, 0.75), 'Victoria'),
        const _State(
            1.044, Color.fromRGBO(126, 247, 74, 0.75), 'Le sud de lAustralie'),
        const _State(
            2.642, Color.fromRGBO(79, 60, 201, 0.7), 'Australie occidentale'),
        const _State(0.0907, Color.fromRGBO(99, 164, 230, 1), 'Tasmanie'),
        const _State(
            0.0023, Colors.teal, 'Territoire de la capitale australienne')
      ];
    ...
    //Spanish.
      ...
      _statesAreaData = <_State>[
        const _State(
            0.809, Color.fromRGBO(255, 215, 0, 1.0), 'Nueva Gales del Sur'),
        const _State(1.857, Color.fromRGBO(72, 209, 204, 1.0), 'Queensland'),
        const _State(
            1.419, Color.fromRGBO(255, 78, 66, 1.0), 'Territorio del Norte'),
        const _State(0.237, Color.fromRGBO(171, 56, 224, 0.75), 'Victoria'),
        const _State(
            1.044, Color.fromRGBO(126, 247, 74, 0.75), 'Sur de Australia'),
        const _State(
            2.642, Color.fromRGBO(79, 60, 201, 0.7), 'El oeste de Australia'),
        const _State(0.0907, Color.fromRGBO(99, 164, 230, 1), 'Tasmania'),
        const _State(
            0.0023, Colors.teal, 'Territorio de la Capital Australiana')
      ];
