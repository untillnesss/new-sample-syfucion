...
class RangeSelectorLabelCustomization extends SampleView {
  /// Renders the range selector with line chart label customization option
  const RangeSelectorLabelCustomization(Key key) : super(key: key);

  @override
  _RangeSelectorLabelCustomizationState createState() =>
      _RangeSelectorLabelCustomizationState();
}

class _RangeSelectorLabelCustomizationState extends SampleViewState
  ...
  void initState() {
    ...
    splineSeriesData = <ChartSampleData>[
      ChartSampleData(
          x: DateTime.fromMillisecondsSinceEpoch(1483315200000), y: 0.9557),
      ChartSampleData(
          x: DateTime.fromMillisecondsSinceEpoch(1483401600000), y: 0.963),
      ChartSampleData(
      ...
      ChartSampleData(
          x: DateTime.fromMillisecondsSinceEpoch(1500249600000), y: 0.8725),
      ChartSampleData(
  ...
  void _onLabelPositionTypeChange(String item) {
    ...
    if (_selectedLabelPlacementType == 'betweenTicks') {
      _labelPlacement = slider.LabelPlacement.betweenTicks;
    }
    setState(() {
  ...
  void _onPositionTypeChange(String item) {
    ...
    if (_selectedType == 'auto') {
      _edgeLabelPlacement = slider.EdgeLabelPlacement.auto;
    }
